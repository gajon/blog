...
git is telling us that we are now in a _detached HEAD_ state. This means that
...
The second thing to notice is that the commit being at the very top is the
